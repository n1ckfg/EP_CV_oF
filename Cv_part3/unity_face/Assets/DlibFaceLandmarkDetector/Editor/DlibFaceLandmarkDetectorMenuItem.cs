...
new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.Android,new Dictionary<string, string> ()
           ...
           new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.Android,new Dictionary<string, string> ()
                {{"CPU", "x86"}
						...
						//OSX
						SetPlugins (new string[] { "Assets/DlibFaceLandmarkDetector/Plugins/dlibfacelandmarkdetector.bundle" }, new Dictionary<string, string> () { { "CPU", "AnyCPU" }, { "OS", "OSX" } },
new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.StandaloneOSXIntel,new Dictionary<string, string> ()
                ...
                {{"CPU", "AnyCPU"}
						...
						//Windows
						SetPlugins (new string[] { "Assets/DlibFaceLandmarkDetector/Plugins/x86/dlibfacelandmarkdetector.dll" }, new Dictionary<string, string> () { { "CPU", "x86" }, { "OS", "Windows" } },
                   new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.StandaloneWindows,new Dictionary<string, string> ()
                        {{"CPU", "x86"}
                }}});

						SetPlugins (new string[] { "Assets/DlibFaceLandmarkDetector/Plugins/x86_64/dlibfacelandmarkdetector.dll" }, new Dictionary<string, string> () { { "CPU", "x86_64" }, { "OS", "Windows" } },
        new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.StandaloneWindows64,new Dictionary<string, string> ()
                {{"CPU", "x86_64"}
						...
						//Linux
						SetPlugins (new string[] { "Assets/DlibFaceLandmarkDetector/Plugins/x86/libdlibfacelandmarkdetector.so" }, new Dictionary<string, string> () { { "CPU", "x86" }, { "OS", "Linux" } },
        new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.StandaloneLinux,new Dictionary<string, string> ()
                {{"CPU", "x86"}
                }},});

						SetPlugins (new string[] { "Assets/DlibFaceLandmarkDetector/Plugins/x86_64/libdlibfacelandmarkdetector.so" }, new Dictionary<string, string> () { { "CPU", "x86_64" }, { "OS", "Linux" } },
        new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.StandaloneLinux64,new Dictionary<string, string> ()
                {{"CPU", "x86_64"}
						...
						//WSA
						SetPlugins (GetPluginFilePaths ("Assets/DlibFaceLandmarkDetector/Plugins/WSA/SDK81/ARM"), null,
                         new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
                {{"SDK", "SDK81"},{"CPU", "ARM"}
                }}});
						SetPlugins (GetPluginFilePaths ("Assets/DlibFaceLandmarkDetector/Plugins/WSA/SDK81/x64"), null,
new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
                {{"SDK", "SDK81"},{"CPU", "x64"}
                }}});
						SetPlugins (GetPluginFilePaths ("Assets/DlibFaceLandmarkDetector/Plugins/WSA/SDK81/x86"), null,
                         new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
                {{"SDK", "SDK81"},{"CPU", "x86"}
                }}});

						SetPlugins (GetPluginFilePaths ("Assets/DlibFaceLandmarkDetector/Plugins/WSA/PhoneSDK81/ARM"), null,
new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
                {{"SDK", "PhoneSDK81"},{"CPU", "ARM"}
                }}});
						SetPlugins (GetPluginFilePaths ("Assets/DlibFaceLandmarkDetector/Plugins/WSA/PhoneSDK81/x86"), null,
                         new Dictionary<BuildTarget, Dictionary<string, string>> (){{BuildTarget.WSAPlayer,new Dictionary<string, string> ()
